...
<tiles:insertDefinition name="layout"> 
    <tiles:putAttribute name="body"> 
        <div class="row">
            <div class="col-md-12">
                <h4>
                    <spring:message code="fonction.new.title"/>
                </h4>
                <hr/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <spring:url value="/fonction/create" var="fonction_save"
                            htmlEscape="true" />
                <form:form method="post" commandName="fonction" action="${fonction_save}">
