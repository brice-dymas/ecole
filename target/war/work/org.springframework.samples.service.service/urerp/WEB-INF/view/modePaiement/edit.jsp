...
<tiles:insertDefinition name="layout">
    <tiles:putAttribute name="body">
        <div class="row">
            <div class="col-md-12">
                <h4>
                    <spring:message code="modePaiement.edit.title"/>
                </h4>
                <hr/>
            </div>
        </div>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <spring:url value="/modePaiement/update" var="modePaiement_update" htmlEscape="true"/>
                        <form:form method="post" commandName="modePaiement" action="${modePaiement_update}">
