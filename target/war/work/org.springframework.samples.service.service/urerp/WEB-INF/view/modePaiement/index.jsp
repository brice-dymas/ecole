            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h4>
                            <spring:message code="modePaiement.list.title"/>
                        </h4>
                        <hr/>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>
                                        <spring:message code="modePaiement.id"/>
                                    </th>
                            ...
                            <tbody>
                                <c:forEach items="${modePaiements}" var="modePaiement">
                                    <tr>
                                        ...
                                        <td>
                                            <spring:url value="/modePaiement/${modePaiement.id}/edit" htmlEscape="true" var="modePaiement_edit" />
                                            <a href="${modePaiement_edit}" class="btn btn-primary btn-xs">
                                                <span class="glyphicon glyphicon-edit"></span>
                                                <spring:message code="action.edit"/>
                                            </a>
                                            &nbsp;&nbsp;
                                            <spring:url value="/modePaiement/${modePaiement.id}/show" htmlEscape="true" var="modePaiement_show" />
                                            <a href="${modePaiement_show}" class="btn btn-primary btn-xs">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <spring:url value="/modePaiement/new" htmlEscape="true" var="modePaiement_new" />
                        <a href="${modePaiement_new}" class="btn btn-primary btn-sm">
                ...
                <form action="${modePaiement_home}" method="get">
